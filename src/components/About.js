  ...
  return (
    <div className='about container section' id='about'><h2 className='section__title text-white'>
      ...
      <div className=" mx-auto my-8 p-8 bg-white rounded-lg shadow-md w-10/12		">
        ...
        <a href='https://drive.google.com/file/d/1E0HIyQVYQ_GtvAkp41KPo33kc9Oa_Pjw/view?usp=drive_link' target="_blank" className='btn mt-4 text-center'>Download Resume</a>
      </div>
    </div>
  )
}
